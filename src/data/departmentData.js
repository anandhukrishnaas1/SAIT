export const departmentData = {
  ...
  history: [
    {
      year: "1995",
      title: "Division Inception",
      description: "Established under the School of Engineering, Cochin University of Science and Technology, as one of the pioneer IT engineering programs in Kerala."
    },
    {
      year: "2003",
      title: "SAIT Inauguration",
      description: "Founded the Students Association of Information Technology to serve as the unified student body for technical symposiums and peer learning."
    },
    {
      year: "2015",
      title: "Advanced Research Labs",
      description: "Commissioned dedicated research laboratories for AI/Machine Learning, Cloud Computing, Cyber Security, and IoT systems."
    },
    {
      year: "2022",
      title: "National Hackathon Accolades",
      description: "SAIT student teams secured multiple Top 3 finishes in Smart India Hackathon and leading national tech competitions."
    },
    {
      year: "2026",
      title: "SAIT 2.0 Digital Renaissance",
      description: "Redesigning the student ecosystem with digital activity tracking, automated mentorship workflows, and placement hubs."
    }
  ],
  faculty: [
    {
